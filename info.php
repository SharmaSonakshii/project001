                ...
                <div class="row g-0">
                    <div class="col-md-4 p-3">
                        <div class="card text-center " style="width: 18rem;">
                            <img src="young-bearded-man-with-striped-shirt.jpg" class="rounded-top  p-3 pb-0 "
                            ...
                            <div class="card p-3 ">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 pt-2">
                                        ...
                                        <input type="text" class="form-control" id="input2" placeholder="Enter Id code" name="id" value ="<?php print_r($row['id code'])?>">
                                    </div>
                                    <div class="col-md-6 pt-2">
